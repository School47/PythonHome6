...
def make_me_progression(first_el:int, step:int, amount_of_elements:int):
    return [first_el+(i-1)*step for i in range(1,amount_of_elements+1)]

print('Примеры/Тесты:')
print('Ввод: 7 2 5')
print(f"Вывод: {make_me_progression(7,2,5)}")
print('Ввод: 2 3 12')
print(f"Вывод: {make_me_progression(2,3,12)}")

a1, n, d = [int(x) for x in input("Введите первый элемент, разность и количество элементов через пробел: ").split()]
print(make_me_progression(a1,n,d))